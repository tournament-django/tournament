...
>>>>>>> aacdbe03842857d8502ff79a8edf88ce7221609b
...
<<<<<<< HEAD
    ...
    url(r'^createShotokan/', 'karateshotokan.views.KarateShotokanCreate', name='KarateShotokanCreate'),
    url(r'^chooseShotokan/', 'karateshotokan.views.KarateShotokanChoose', name='KarateShotokanChoose'),
    url(r'^createTeamShotokan/', 'karateshotokan.views.KarateShotokanCreateTeam', name='KarateShotokanCreateTeam'),
